...
const navigationItems = {
  admin: [
    ...
    { name: 'Routes', href: '/dashboard/admin/routes', icon: Route, badge: 'Lines' },
    { name: 'Route Requests', href: '/dashboard/admin/route-requests', icon: GitPullRequest, badge: 'Review' },
    { name: 'Live Tracking', href: '/dashboard/admin/tracking', icon: Radio, badge: 'Live' },
    { name: 'Trips', href: '/trips', icon: Calendar, badge: 'Schedule' },
    { name: 'Plans', href: '/dashboard/admin/plans', icon: CreditCard, badge: 'Catalog' },
    { name: 'Pricing', href: '/dashboard/admin/pricing', icon: Tags, badge: 'Rules' },
    { name: 'Discounts', href: '/dashboard/admin/discounts', icon: Percent, badge: 'Siblings' },
    { name: 'Instalments', href: '/dashboard/admin/installment-plans', icon: CalendarClock, badge: 'Schedules' },
    ...
    { name: 'Audit Log', href: '/dashboard/admin/audit', icon: ScrollText, badge: 'History' },
